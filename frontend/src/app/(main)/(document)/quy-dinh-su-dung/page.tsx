...
export default function page() {
  return (
    ...
    >
      ...
      <h3 className={cn("mt-2 font-bold")}>1. Hướng dẫn sử dụng web</h3>
      <ul className={cn("list-disc space-y-1 pl-4")}>
        ...
        <li>
          ...
          Hơn nữa, quý khách phải thông báo cho chúng tôi biết khi tài khoản bị
          truy cập trái phép. Chúng tôi không chịu bất kỳ trách nhiệm nào, dù
        ...
        <li>
          ...
          website. Sau đó, nếu không muốn tiếp tục nhận mail, quý khách có thể
          từ chối bằng cách nhấp vào đường link ở dưới cùng trong mọi email
          quảng cáo.
        </li>
      </ul>

      <h3 className={cn("mt-2 font-bold")}>2. Chấp nhận đơn hàng và giá cả</h3>
      <ul className={cn("list-disc space-y-1 pl-4")}>
        <li>
          Chúng tôi có quyền từ chối hoặc hủy đơn hàng của quý khách vì bất kỳ
          lý do gì vào bất kỳ lúc nào. Chúng tôi có thể hỏi thêm về số điện
        ...
        <li>
          ...
          xác nhận hoặc đã bị thanh toán.
        </li>
      </ul>

      <h3 className={cn("mt-2 font-bold")}>3. Thương hiệu và bản quyền</h3>
      <p>
        Mọi quyền sở hữu trí tuệ (đã đăng ký hoặc chưa đăng ký), nội dung thông
        tin và tất cả các thiết kế, văn bản, đồ họa, phần mềm, hình ảnh, video,
        âm nhạc, âm thanh, biên dịch phần mềm, mã nguồn và phần mềm cơ bản đều
        là tài sản của chúng tôi. Toàn bộ nội dung của trang web được bảo vệ bởi
        luật bản quyền của Việt Nam và các công ước quốc tế. Bản quyền đã được
        bảo lưu.
      </p>

      <h3 className={cn("mt-2 font-bold")}>4. Quyền pháp lý</h3>
      <p>
      ...
      <h3 className={cn("mt-2 font-bold")}>5. Quy định về bảo mật</h3>
      <ul className={cn("list-disc space-y-1 pl-4")}>
        <li>
