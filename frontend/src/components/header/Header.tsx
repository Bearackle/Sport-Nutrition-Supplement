...
export const Header = () => {
  return (
    ...
    >
      <div className="relative mx-auto flex h-[6rem] max-w-[75rem] flex-row items-center justify-around py-2">
        <div className="absolute right-8 top-1 flex flex-row items-center gap-1">
        ...
        <Link href="/" className="flex flex-row items-center gap-2">
          <Image src={logo} alt="logo" className="size-[4.5rem]" />
          <p
            className={cn(
              nunito.className,
